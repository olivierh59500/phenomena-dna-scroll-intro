...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.phenomenadna \
    -o android/app/libs/phenomenadna.aar \
    ./mobile
...
echo "→ Installation sur l’appareil Android"
$adb_path install -r "$apk_path"

echo "→ Lancement de Phenomena DNA Scroll Intro"
$adb_path shell am force-stop com.olivierh.phenomenadna
$adb_path shell am start -n com.olivierh.phenomenadna/.MainActivity
